...
@configclass
class VelocityAlignmentLiftEnvCfg(BaselineLiftEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.ee_vertical_alignment = RewTerm(
            func=my_mdp.ee_vertical_alignment,
            weight=0.5,
        )


@configclass
class VelocityAlignmentLiftEnvCfg_PLAY(VelocityAlignmentLiftEnvCfg):
    def __post_init__(self):
        super().__post_init__()
