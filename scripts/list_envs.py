...
All the environments are registered in the `reward_ablation_lift` extension. They start
...
def main():
    """Print all environments registered in `reward_ablation_lift` extension."""
